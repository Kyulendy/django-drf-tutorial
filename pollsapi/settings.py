...
SECRET_KEY = '^5(l@ko8m)xct5u#&y^^biy-o7fp$^w3$hjzid(5-+z_gxwfu+'
...
# DRF tutorial - Chapter 7
REST_FRAMEWORK = {
    # With Django Rest Framework, we can set up a default authentication scheme which is applied to all views
